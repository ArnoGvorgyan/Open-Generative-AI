export function AuthModal(onSuccess) {
    ...
    modal.innerHTML = `
        <div class="flex flex-col items-center text-center mb-8">
            ...
            <h2 class="text-2xl font-black text-white uppercase tracking-wider mb-2">Araqs — Enter API Key</h2>
            <p class="text-secondary text-sm">Please provide your Araqs API key to start creating images and videos.</p>
        </div>
        ...
        <div class="space-y-6">
            <div class="space-y-2">
                ...
                <input 
                    type="password" 
                    id="muapi-key-input"
                    placeholder="Enter your Araqs API key..."
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="https://araqs.ai" target="_blank" class="text-center text-[11px] font-bold text-muted hover:text-white transition-colors py-2 uppercase tracking-tighter">
                    Get an API Key at Araqs.ai →
                </a>
            </div>
        </div>
    `;
